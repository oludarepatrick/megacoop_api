    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="{{ route('home'); }}" class="navbar-brand mx-auto mx-lg-0">Leverpay.io</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-lg-5">
                        ...
                        <li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_4">Support</a>
                        </li>
						...
						<li class="nav-item">
                            <a class="nav-link click-scroll" href="#section_l">Login</a>
                        </li>
                    </ul>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="hero-text">
								<h2><img src="images/logo.png" class="" alt=""></h2>
                                <div class="hero-title-wrap d-flex align-items-center mb-4">
                                    

                                    <h1 class="hero-title ms-3 mb-0">Hello Every one!</h1>
                                </div>

                                <h2 class="mb-4" style="font-size:30px;">pay all your transaction<span style="font-size:25px">(s)</span> with leverpay.io</h2>
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            <div class="about-thumb">
                                ...
                                <div class="section-title-wrap d-flex justify-content-end align-items-center mb-4">
                                    <!--<h2 class="text-white me-4 mb-0">Leverpay.io</h2>-->

                                    <img src="images/logo.png" class="avatar-image1 img-fluid" alt="">
                                </div>

                                <h3 class="pt-2 mb-3">Details about Leverpay.io</h3>

                                <p>This  is provided by <a href="https://templatemo.com" target="_blank">TemplateMo</a>. This kkj is lkklon kk v5.1.3 hjj and JS kjk. Image kk go to <a href="https://nn.com" target="_blank">Unsplash</a> and <a href="https://kj.com" target="_blank">xk</a> for cjkkc ckk in this ck.</p>

                                <p>You are j to use jh hjhjhj for your jhjh. You are not hh to jkjk the template kjjk file on any other hjjh. Please <a href="https://hjjhjh.com/contact" target="_blank">contact us</a> for more info.</p>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="profile-thumb">
                                <div class="profile-title">
                                    <h4 class="mb-0">Leverpay.io usage guidelines</h4>
                                </div>
                            ...
                            <div class="about-thumb">
                                <div class="row">
                                    <div class="col-lg-6 col-6 featured-border-bottom py-2">
                                        ...
                                        <p class="featured-text">Total Contries Operate</p>
                                    </div>

                                    <div class="col-lg-6 col-6 featured-border-start featured-border-bottom ps-5 py-2">
                                        <strong class="featured-numbers">245</strong>

                                        <p class="featured-text">Customers</p>
                                    </div>

                                    <div class="col-lg-6 col-6 pt-4">
                                        <strong class="featured-numbers">40</strong>

                                        <p class="featured-text">Employees</p>
                                    </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-12 col-12">
                            <h3 class="text-center mb-5">Partnership/Collaboration</h3>
                        </div>
                            ...
                            <div class="row pt-lg-5">
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            <h3 class="mb-0">P2P transaction</h3>

                                            <div class="services-price-wrap ms-auto">
                                                <p class="services-price-text mb-0">$2</p>
                                                <div class="services-price-overlay"></div>
                                            </div>
                                        </div>

                                        <p>To list your gghhg first on any hjjhjh engine, we will work jhjj. First hhjf is one-page CSS hjjh for free ghhj.</p>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb services-thumb-up">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            <h3 class="mb-0">Currency Exchange</h3>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="services-thumb">
                                        <div class="d-flex flex-wrap align-items-center border-bottom mb-4 pb-3">
                                            <h3 class="mb-0">B2B Transaction</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-12 ms-auto">
                            <div class="section-title-wrap d-flex justify-content-center align-items-center mb-4">
                                ...
                                <h2 class="text-white ms-4 mb-0">Support</h2>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">dev</small>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">fin</small>

                                    <h3 class="projects-title">Finance</h3>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="projects-thumb">
                                <div class="projects-info">
                                    <small class="projects-tag">Technical</small>

                                    <h3 class="projects-title">Technical</h3>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-12 pe-lg-0">
                                <div class="contact-info contact-info-border-start d-flex flex-column">
                                    ...
                                    <ul class="footer-menu">
                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">P2P</a></li>

                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">B2B</a></li>

                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">DirectPay</a></li>

                                        <li class="footer-menu-item"><a href="#" class="footer-menu-link">Other</a></li>
                                    </ul>

                                    <strong class="site-footer-title d-block mt-4 mb-3">Stay connected with leverpay.io</strong>
                                    ...
                                    <strong class="site-footer-title d-block mt-4 mb-3">Get start now</strong>

                                    <p class="mb-0">We are 247 available just for you</p>
                                </div>
                            </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox2">
                                                    ...
                                                    <span class="form-check-label-text">Technical</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox3">
                                                    ...
                                                    <span class="form-check-label-text">Finance</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-md-6 col-6">
                                            <div class="form-check form-check-inline me-0">
                                                ...
                                                <label class="form-check-label" for="inlineCheckbox4">
                                                    ...
                                                    <span class="form-check-label-text">Service Customers</span>
                                                </label>
                                            </div>
                                        </div>
